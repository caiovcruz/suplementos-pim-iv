...
namespace SuplementosPIMIV.Controller
{
    public class ControllerProduto : ModelProduto
    {
        ...
        public ControllerProduto(int id_categoria, int id_subcategoria, int id_sabor, string nm_produto, string ds_produto, int qtd_estoque, double pr_custo, double pr_venda) :
            base(id_categoria, id_subcategoria, id_sabor, nm_produto, ds_produto, qtd_estoque, pr_custo, pr_venda) { }

        public ControllerProduto(int id_produto, int id_categoria, int id_subcategoria, int id_sabor, string nm_produto, string ds_produto, int qtd_estoque, double pr_custo, double pr_venda) :
