...
namespace SuplementosPIMIV.Controller
{
    public class ControllerProduto : ModelProduto
    {
        ...
        public ControllerProduto(int id_marca, int id_categoria, int id_subcategoria, int id_sabor, string nr_ean, string nm_produto, 
            ...
            base(id_marca, id_categoria, id_subcategoria, id_sabor, nr_ean, nm_produto, ds_produto, pr_custo, pr_venda, connectionString) { }
        ...
        public ControllerProduto(int id_produto, char acao, string connectionString) : base(id_produto, acao, connectionString) { }
    }
}